...
G1_ACTUATOR_ARM = UnitreeActuatorCfg_N5020_16(
  target_names_expr=(
  ...
  effort_limit=25.0, armature=ARMATURE_5020,
)
G1_ACTUATOR_HIP_PITCH_YAW = UnitreeActuatorCfg_N7520_14p3(
  target_names_expr=(".*_hip_pitch_joint", ".*_hip_yaw_joint"),
  stiffness=100.0, damping=2.0,
  effort_limit=88.0, armature=ARMATURE_7520_14,
)
G1_ACTUATOR_WAIST_YAW = UnitreeActuatorCfg_N7520_14p3(
  target_names_expr=("waist_yaw_joint",),
  stiffness=200.0, damping=5.0,
  effort_limit=88.0, armature=ARMATURE_7520_14,
)
G1_ACTUATOR_HIP_ROLL = UnitreeActuatorCfg_N7520_22p5(
  target_names_expr=(".*_hip_roll_joint",),
  stiffness=100.0, damping=2.0,
  effort_limit=139.0, armature=ARMATURE_7520_22,
)
G1_ACTUATOR_KNEE = UnitreeActuatorCfg_N7520_22p5(
...
# )
G1_ACTUATOR_WRIST = UnitreeActuatorCfg_N5010_16(
  target_names_expr=(".*_wrist_pitch_joint", ".*_wrist_yaw_joint"),
  stiffness=40.0, damping=1.0,
  effort_limit=5.0, armature=ARMATURE_5010_16,
)
...
G1_ACTUATOR_WAIST = UnitreeActuatorCfg_N5020_16(
  ...
  effort_limit=25.0, armature=ARMATURE_5020 * 2,
)
